            ...
            <form clasName="needs-validation" novalidate>
              <div clasName="form-row">
                <div clasName="col-md-4 mb-3">
                  ...
                  <input type="text" clasName="form-control" id="validationCustom01" placeholder="First name" name="fn" required></input>
              ...
              <div clasName="col-md-4 mb-3">
                ...
                <input type="text" clasName="form-control" id="validationCustom02" placeholder="Last name" name="ln" required></input>
                <div clasName="valid-feedback">
                  Looks good!
                </div>
              </div>
              ...
              <div clasName="form-row">
                <div clasName="col-md-6 mb-3">
                  ...
                  <input type="password" clasName="form-control" id="validationCustom03" placeholder="Password" name="password" required></input>
